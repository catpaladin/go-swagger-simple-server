...
import (
	...
	"github.com/catpaladin/go-swagger-simple-server/models"
	"github.com/catpaladin/go-swagger-simple-server/restapi/operations"
	"github.com/catpaladin/go-swagger-simple-server/restapi/operations/todos"
)

//go:generate swagger generate server --target ../../go-swagger-simple-server --name TodoList --spec ../swagger.yml
